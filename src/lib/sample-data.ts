    ...
    variantOptions: [
      {
        id: 'opt-aero-color',
        name: 'اللون',
        values: ['رمادي قمري', 'أسود كربوني'],
      },
      {
        id: 'opt-aero-switch',
        name: 'نوع المفاتيح',
        values: ['خطية صامتة (Linear)', 'لمسية ميكانيكية (Tactile)'],
      },
    ],
    variants: [
      {
        id: 'var-aero-1',
        title: 'رمادي قمري / خطية صامتة (Linear)',
        price: '24,500 دج',
        inStock: true,
        imageId: 'img-aero-1',
        imageUrl:
        ...
        options: {
          اللون: 'رمادي قمري',
          'نوع المفاتيح': 'خطية صامتة (Linear)',
        },
      },
      {
        id: 'var-aero-2',
        title: 'رمادي قمري / لمسية ميكانيكية (Tactile)',
        price: '24,500 دج',
        inStock: true,
        imageId: 'img-aero-2',
        imageUrl:
        ...
        options: {
          اللون: 'رمادي قمري',
          'نوع المفاتيح': 'لمسية ميكانيكية (Tactile)',
        },
      },
      {
        id: 'var-aero-3',
        title: 'أسود كربوني / خطية صامتة (Linear)',
        price: '25,900 دج',
        inStock: true,
        imageId: 'img-aero-3',
        imageUrl:
      ...
      {
        id: 'var-aero-4',
        title: 'أسود كربوني / لمسية ميكانيكية (Tactile)',
        price: '25,900 دج',
        inStock: true,
        imageId: 'img-aero-4',
        imageUrl:
